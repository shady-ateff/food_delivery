...
List<MenuItem> Menu =[
  MenuItem(name: "Original Beef Burger", location: "assets/images/item (1).png", price: 2.99 , isFavorite: true),
  MenuItem(name: "Beef Burger & Fries", location: "assets/images/item (2).png", price: 3.49, isFavorite: true),
  MenuItem(name: "Chicken Burger\nExtra Ranch", location: "assets/images/item (3).png", price: 3.99, isFavorite: true),
